...
Physical return of an item does not replace a withdrawal declaration where a declaration is required.
...
An already clear withdrawal declaration does not have to be repeated solely because the corresponding business process has not yet been completed.
...
The financial consequences of a partial return, including treatment of the original Standard Delivery cost and the final partial-refund amount, are governed by the Refund Policy.
...
The customer should retain proof of dispatch until the return and refund process has been completed.
...
A return being dispatched or received does not by itself mean that the refund has been completed.

## 17. Policy Boundaries

This policy does not define:

- final refund calculations;
- repayment rules;
- warranty, defect, damage, or compensation processes;
